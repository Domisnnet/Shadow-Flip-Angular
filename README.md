...
> 💡 Uma combinação entre **arquitetura robusta Angular** e **nostalgia dos duelos de cartas**.
...
| :-------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------- |
| **Frontend**    | ![Angular](https://img.shields.io/badge/Angular-DD0031?style=flat-square\&logo=angular\&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square\&logo=typescript\&logoColor=white) | Framework robusto e altamente escalável.       |
| **Arquitetura** | ![RxJS](https://img.shields.io/badge/RxJS-B7178C?style=flat-square\&logo=reactivex\&logoColor=white)                                                                                                                       | Programação reativa e gerenciamento de estado. |
...
<p>🃏 Um jogo da memória com estética inspirada em Yu-Gi-Oh!, desenvolvido com Angular para demonstrar arquitetura escalável e performance.</p>
</details>

<details>
<summary><strong>É possível jogar online ❓</strong></summary>
<p>✅ Sim! O duelo estará disponível na seção de implantação.</p>
</details>

<details>
<summary><strong>Como fazer o deploy ❓</strong></summary>
<p>Você pode utilizar Firebase Hosting ou GitHub Pages após gerar o build com <code>ng build</code>.</p>
</details>

<details>
<summary><strong>Posso contribuir com o projeto ❓</strong></summary>
<p>Claro! Siga o guia e fortaleça este deck com novas funcionalidades 🚀</p>
</details>
